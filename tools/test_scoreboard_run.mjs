...

{
  ...
  ck("the milestone is written into the card's result area",
     /function showMilestone[\s\S]{0,700}querySelector\("\.quiz-result"\)/.test(app));
  ck("and never opens a dialog or a toast", (() => {
    const at = app.indexOf("function showMilestone");
